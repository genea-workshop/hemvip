...
function PageManager (_variableName, _htmlParenElementId, _localizer) {
    ...
    // Stereo audio test page
    this.failedAudioTest = false;
}
...
PageManager.prototype.shouldTerminateStudy = function() {
  ...
  shouldTerminate = shouldTerminate || this.failedAudioTest;
...
PageManager.prototype.reloadVideo = function () {
  var currPage = pageManager.getCurrentPage();
  currPage.videoVisualizer.reload();
}
