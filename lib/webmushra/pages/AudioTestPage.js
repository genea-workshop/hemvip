...
AudioTestPage.prototype.onTestSuccess = function() {
  ...
  this.lockCheckBtn();
  this.lockNumpads();
  $('#audio_reset_button').attr('disabled', 'disabled');
};
...
AudioTestPage.prototype.onTestFailed = function() {
  ...
  console.log(this.pageManager.failedAudioTest);
};
...
AudioTestPage.prototype.render = function (_parent) {
  ...
  var resetBtn = $("<button id='audio_reset_button' class='control-button'>Reset Input</button>");
  var checkBtn = $("<button id='audio_check_button' class='control-button'>Check Input</button>");
  entryControls.append(resetBtn);
  entryControls.append(playBtn);
  entryControls.append(checkBtn);
  playBtn.on("click", () => { return this.playAudio(); });
  resetBtn.on("click", () => { return this.resetEntries(); });
